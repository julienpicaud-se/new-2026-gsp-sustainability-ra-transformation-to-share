...
const successMetrics = [
  {
    icon: Timer,
    metric: "Sustainability Assessment Cycle Time",
    description: "Average days from kickoff to deliverable for sustainability assessments and decarbonization roadmaps.",
    indicator: "Throughput",
    signal: "Days per assessment (trend)",
  },
  {
    icon: TrendingUp,
    metric: "Advisory-to-Engagement Conversion",
    description: "Share of in-product sustainability advisory prompts that convert into a paid expert engagement.",
    indicator: "Conversion Rate",
    signal: "% prompts to engagements",
  },
  {
    icon: Clock,
    metric: "Time to Quote",
    description: "Median hours from opportunity identification to signed quote for sustainability engagements.",
  ...
  },
  {
    ...
    description: "Share of in-product sustainability recommendations acted on by RA+ users within 90 days.",
  ...
  },
  {
    ...
    description: "Recurring revenue attributable to sustainability features as a share of RA+ ARR.",
